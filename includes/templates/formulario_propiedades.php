...
<fieldset>
    ...
    <input type="number" id="estacionamiento" name="propiedad[estacionamiento]" placeholder="Ejemplo: 3" min="1" max="9" value="<?php echo s($propiedad->estacionamiento); ?>">
</fieldset>
<fieldset>
    ...
    <select name="propiedad[vendedores_id]" id="vendedor">
        <option selected value="">Seleccionar Vendedor</option>
