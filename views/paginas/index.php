<main class="contenedor seccion">
    ...
    <section class="imagen-contacto">
        ...
        <p>Llena el formulario de contacto y un asesor se pondrá en contecto contigo a la brevedad</p>
            ...
            <article class="entrada-blog">
                ...
                <div class="texto-entrada">
                    <a href="entrada.html">
                        ...
                        <p>
                            Consejos para contruir una terraza en el techo de tu casa para con los mejores 
                            y ahorrando dinero.
                        </p>
                    </a>
                </div>
        ...
        <section class="testimoniales">
            ...
            <div class="testimonial">
                <blockquote>
                    ...
                    me ofrecieron cumple todas mis expectativas.
                </blockquote>
                <p>- Elias Tofaletti</p>
            </div>
        </section>
